...
public final class MailTemplate {
    ...
    public static String generateCaseCreatedEmailForArbitrator() {
        ...
        String companyName = "Mac Legal Portal";
        int year = 2025;
        String caseLink = "https://app.mac.org.in/webapp/login";
    ...
    public static String generateAdmissionFormExistingClaimantCaseEmail() {
        ...
        String companyName = "Mac Legal Portal";
        int year = 2025;
        String loginLink = "https://app.mac.org.in/webapp/login";
    ...
    public static String generateAdmissionFormNewRespondentRegistrationEmail() {

        String companyName = "Mac Legal Portal";
        int year = 2025;
        String registerLink = "https://app.mac.org.in/webapp/register";
    ...
    """.formatted(registerLink, companyName, year, companyName);
    }
