 ...
 * Date        : 2025-09-01
 * Company     : Webzworld
 * File        : Respondant.java
 * Purpose     : Creates Respondant Entity for the application
 * -----------------------------------------------------------------------------
 */
...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "admission_form_respondant",uniqueConstraints = {
        @jakarta.persistence.UniqueConstraint(columnNames = "id")
})
public class AdmissionFormRespondant {
    @Id
